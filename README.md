...
- [emojipasta.club](http://emojipasta.club), a web service that exposes RESTful endpoints for generating and tweeting emojipastas, as well as a simple frontend for generating and tweeting emojipasta sentences. [[code](https://github.com/ntratcliff/emojipasta.club)]
